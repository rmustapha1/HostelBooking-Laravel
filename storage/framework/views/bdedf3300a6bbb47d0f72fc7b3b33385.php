...
<body>
    <div class="container">
        <div class="no-print">
            <table>
                <tr>
                    <td><a href="<?php echo e(route('home')); ?>" class="btn btn-info"><i class="bi bi-arrow-left"></i> Back</a> </td>
        ...
        <div class="row items-center justify-center">
            ...
            <div class="col">
                <img src="<?php echo e(asset('images/android-chrome-512x512.png')); ?>" height="60" width="60"
                    style="margin:10px 0;filter: brightness(0);">
            </div>
        </div>
        <h1 class="centered font-black text-3xl">Invoice: <?php echo e($invoiceNumber); ?></h1>
        <?php
        $date = date('Y-m-d H:i:s');
        $name = $user->fname . " " . $user->lname;
        ?>
        <p>Date: <?php echo e($date); ?><br>
            Reference: <?php echo e($payment->transaction_id); ?><br>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo e($booking->room->room_no); ?></td>
                    <td><?php echo e($booking->check_in_date); ?></td>
                    <td><?php echo e($booking->check_out_date); ?></td>
                    <td><?php echo e($booking->room->room_type); ?></td>
                    <td class="text-right"><?php echo e($payment->amount); ?></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <th class="centered" colspan="3">In Words: <span>GH&#8373;</span>
                        <span><?php echo e(str_replace("-"," ",$amountInWords)); ?></span>
                    </th>
                </tr>
            </tfoot>
        </table>
...
</html><?php /**PATH C:\Users\PC\HostelBooking\resources\views/booking/invoice.blade.php ENDPATH**/ ?>