            ...
            <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <li class="text-sm">
                    <a href="#" aria-current="page"
                        class="font-medium text-gray-500 hover:text-gray-600"><?php echo e($hostel->name); ?></a>
                </li>
            </ol>
        </nav>
                ...
                <div class="mt-10">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <img src="<?php echo e(asset('images/profile.png')); ?>" alt="<?php echo e($review->user->fname); ?>"
                                class="w-10 h-10 rounded-full mr-2">
                            <?php endif; ?>
                            <img src="<?php echo e($review->user->profile_photo_url); ?>" alt="<?php echo e($review->user->fname); ?>"
                                class="w-10 h-10 rounded-full mr-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-6">
                            <a href="<?php echo e(route('booking.step1', ['room_id' => $room->id])); ?>"
