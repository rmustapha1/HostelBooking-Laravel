    ...
    <div class="pt-6 mt-20">
        <nav aria-label="Breadcrumb">
            <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <li class="text-sm">
                    <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600"><?php echo e($hostel->name); ?></a>
                </li>
            </ol>
        </nav>
        ...
        <div class="mx-auto px-3 py-3">
            <div class="sm:overflow-hidden rounded-lg sm:rounded-lg">
                <img src="<?php echo e($hostel->img_url); ?>" alt="<?php echo e($hostel->name); ?>" class="h-full w-full object-cover object-center">
            </div>
        </div>
        ...
        <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl"><?php echo e($hostel->name); ?></h1>
            </div>

            <!-- Options -->
            <div class="mt-4 lg:row-span-3 lg:mt-0">
                <h2 class="sr-only">Hostel information</h2>
                <p class="text-3xl tracking-tight text-gray-900">&#8373;<?php echo e($hostel->price_range); ?></p>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ml-3 text-sm font-medium text-blue-600 hover:text-blue-500"><?php echo e($reviews); ?>
            ...
            <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <p class="text-base text-gray-900"><?php echo e($hostel->description); ?></p>
                    </div>
                </div>
                ...
                <div class="mt-10">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <?php if($hostel->images->isNotEmpty()): ?>
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 px-2 mb-4">
                            <img src="<?php echo e($image); ?>" alt="<?php echo e($hostel->name); ?>" class="w-full h-auto">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                        <div class="w-full px-2 mb-4">
                            <p>No images available for <?php echo e($hostel->name); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mt-10">
                    ...
                    <?php if($hostel->reviews): ?>
                    <?php $__currentLoopData = $hostel->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-4">
                        <div class="flex items-center mb-2">
                            ...
                            ?>
                            <span class="text-lg font-semibold"><?php echo e($rating); ?></span>
                        </div>
                        <p class="text-gray-700 text-lg mb-2"><?php echo e($review->comment); ?></p>
                        <div class="flex items-center">
                            <?php if($review->user): ?>
                            <?php if($review->user->profile_photo_url == null): ?>
                            <img src="<?php echo e(asset('images/profile.png')); ?>" alt="<?php echo e($review->user->fname); ?>" class="w-10 h-10 rounded-full mr-2">
                            <?php endif; ?>
                            <img src="<?php echo e($review->user->profile_photo_url); ?>" alt="<?php echo e($review->user->fname); ?>" class="w-10 h-10 rounded-full mr-2">
                            <p class="text-sm text-gray-600"><?php echo e($review->user->fname); ?></p>
                            <p class="text-sm text-gray-600"><i class="bi bi-clock"></i> <?php echo e($date); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="reserve" class="mx-auto container">
            ...
            <table class="table-auto w-full table-stripe table-primary border-separate border border-blue-800">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border px-4 py-4"><?php echo e($room->room_no); ?></td>
                        <td class="border px-4 py-4"><?php echo e($room->room_type); ?></td>
                        <td class="border px-4 py-4"><?php echo e($room->price_per_year); ?></td>
                        <td class="border px-4 py-4"><?php echo e($room->total_slots); ?></td>
                        <td class="border px-4 py-4"><?php echo e($room->available_slots); ?></td>
                        <td class="border px-4 py-6">
                            <a href="<?php echo e(route('booking.step1', ['room_id' => $room->id])); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">I'll
                                Reserve</a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\HostelBooking\resources\views/hostels/show.blade.php ENDPATH**/ ?>