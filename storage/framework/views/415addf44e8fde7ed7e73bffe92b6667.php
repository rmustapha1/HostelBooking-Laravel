                ...
                <div class="bg-white rounded-lg border-gray-300 border-2 p-4 mb-2">
                    ...
                    <div class="row items-center mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <span class="font-bold text-gray-950 text-lg pr-5 border-r-2 border-gray-300"><?php echo e($checkInDate); ?></span>
                        </div>
                        <div class="col-6">
                ...
                <form id="booking-form" method="post" action="<?php echo e(route('booking.saveBooking')); ?>">
                    ...
                    <div class="border-gray-300 border-2 rounded-sm p-4 mb-3">
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="first_name" name="fname" placeholder="Enter your first name" value="<?php echo e($user->fname); ?>" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <!-- Last name -->
                            <div class="col-md-6 mb-3">
                                <label for="last_name" class="text-gray-600 font-medium">Last name</label>
                                <input type="text" id="last_name" name="lname" placeholder="Enter your last name" value="<?php echo e($user->lname); ?>" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <!-- Email address -->
                            <div class="col-md-6 mb-3">
                                <label for="email" class="text-gray-600 font-medium">Email address</label>
                                <input type="email" id="email" name="email" placeholder="Enter your email address" value="<?php echo e($user->email); ?>" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <!-- Country/region -->
                            <div class="col-md-6 mb-3">
                                <label for="school" class="text-gray-600 font-medium">Your
                                    school/campus</label>
                                <input type="text" id="school" name="school" placeholder="Enter your school name" value="<?php echo e($hostel->school->name); ?>" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                    ...
                    <div class="border-gray-300 border-2 rounded-sm p-4 mb-4">
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" id="check_in_date" name="check_in_date" placeholder="Enter your check-in date" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?php echo e($checkInDate); ?>" required disabled>
                            </div>
                            <!-- Check-Out-Date -->
                            <div class="col-md-6 mb-3">
                                <label for="check_out_date" class="text-gray-600 font-medium">Check-Out-Date</label>
                                <input type="date" id="check_out_date" name="check_out_date" value="<?php echo e($checkOutDate); ?>" placeholder="Enter your check-out date" class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required disabled>
                            </div>
                    ...
                    <div class="pt-5 float-right">
                        <button type="submit" id="submit-button" class="bg-blue-500 text-white px-4 py-3 rounded-lg hover:bg-blue-600">
                            ...
                            <img id="submit-loader" src="<?php echo e(asset('images/loader.gif')); ?>" alt="Loading..." style="display:none;">
                        </button>
                    </div>
                </form>
            </div>
