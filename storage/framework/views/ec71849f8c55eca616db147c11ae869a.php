                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <input id="first_name" type="text"
                                        class="form-control w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['fname'];
...
unset($__errorArgs, $__bag); ?>"
                                        name="fname" value="<?php echo e(old('fname', $user->fname)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-3">
                                    <input id="last_name" type="text"
                                        class="form-control w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['lname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        name="lname" value="<?php echo e(old('lname', $user->lname)); ?>" required
...
unset($__errorArgs, $__bag); ?> w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('booking.step2', ['bookingId' => $booking->id])); ?>"
