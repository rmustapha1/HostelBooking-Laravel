...
<body class="bg-white">
    <header class="bg-white fixed inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="{{ route('hostels.index') }}" class="text-sm font-semibold leading-6 text-gray-700">Find
                    Rooms</a>
  ...
  <div class="container mx-auto px-5 pt-[40px] pb-[48px] lg:px-[60px] lg:pt-[70px]">
    ...
    <img class="h-14 w-auto rounded mt-4" src="{{ asset('images/quellhub_bg.jpg') }}" alt="logo">
    </a>
    <div class="mt-8 grid grid-cols-1 gap-12 lg:grid-cols-4">
      ...
      <div class="col-span-1">
        ...
        <div class="mt-4">
        <img class="h-16 w-auto rounded" src="{{ asset('images/quellhub_icon.jpg') }}" alt="logo"> 
        </div>
      </div>
      <div class="col-span-1">
