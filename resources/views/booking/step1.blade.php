                ...
                <div class="bg-white rounded-lg border-gray-300 border-2 p-4 mb-2">
                    ...
                    <div class="row items-center mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <span
                                class="font-bold text-gray-950 text-lg pr-5 border-r-2 border-gray-300">{{$checkInDate}}</span>
                        </div>
                        <div class="col-6">
                ...
                <form id="booking-form" method="post" action="{{route('booking.saveBooking')}}">
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" id="check_in_date" name="check_in_date"
                                    ...
                                    class="w-full bg-gray-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    value="{{$checkInDate}}" required readonly>
                            </div>
                            <!-- Check-Out-Date -->
                            <div class="col-md-6 mb-3">
                                <label for="check_out_date" class="text-gray-600 font-medium">Check-Out-Date</label>
                                <input type="date" id="check_out_date" name="check_out_date" value="{{$checkOutDate}}"
                    ...
                    <div class="pt-5 float-right">
                        <button type="submit" id="submit-button"
                            ...
                            <img id="submit-loader" src="{{asset('images/loader.gif')}}" alt="Loading..."
                                style="display:none;">
                        </button>
                    </div>
                </form>
