        ...
        <div class="row -mx-4">
            <div class="w-full col-lg-4 px-2">
                <div class="bg-white rounded-lg border-gray-300 border-2 p-4 mb-2">
                    ...
                    <p class="text-gray-700 text-sm mb-2"><i class="bi bi-geo-alt pr-2"></i>{{ $room->hostel->location }}</p>
                ...
                <div class="bg-white rounded-lg border-gray-300 border-2 p-4 mb-2">
                    ...
                    <div class="row items-center mb-3">
                        <div class="col-6">
                            ...
                            <span class="font-bold text-gray-950 text-lg pr-5 border-r-2 border-gray-300">{{$booking->check_in_date}}</span>
                        </div>
                        <div class="col-6">
                            <p class="text-sm text-gray-400">Check-Out</p>
                            <span class="font-bold text-gray-950 text-lg">{{$booking->check_out_date}}</span>
                        </div>
                    </div>
            ...
            <div class="w-full col-lg-8 px-2">
                <form id="payment-form" method="post" action="{{route('pay')}}">
                    ...
                    <div class="border-gray-300 border-2 rounded-sm p-4 mb-3">
                        ...
                        <input type="hidden" name="amount" value="{{$room->price_per_year}}">
                        ...
                        <div class="pt-5 row items-center">
                            ...
                            <div class="col items-center space-x-3">
                                <a href="{{route('home')}}" class="hidden sm:inline md:inline bg-white border-2 border-blue-600 text-blue-500 font-bold px-4 py-3 rounded-lg hover:bg-blue-600">
                                    <span>Pay later</span>
                                </a>
