                ...
                <div class="bg-white rounded-lg border-gray-300 border-2 p-4 mb-2">
                    ...
                    <div class="row items-center mb-3">
                        <div class="col-6">
                            ...
                            <span
                                class="font-bold text-gray-950 text-lg pr-5 border-r-2 border-gray-300">{{$booking->check_in_date}}</span>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="border-gray-300 border-2 rounded-sm p-4 mb-3">
                        ...
                        <div class="pt-5 row items-center">
                            ...
                            <div class="col items-center justify-center">
                                <button
                                    class="hidden lg:bg-white border-2 border-blue-600 text-blue-500 font-bold px-4 py-3 rounded-lg hover:bg-blue-600">
                                    <span>Pay later</span>
                                </button>
                                <button type="submit" id="submit-button"
                                    class="bg-blue-500 text-white font-bold px-4 py-3 rounded-lg hover:bg-blue-600">
                                    <span id="submit-text">Complete booking <i class="bi bi-lock"
