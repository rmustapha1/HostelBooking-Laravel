                ...
                <div class="relative mt-5 rounded-md shadow-sm hidden sm:block md:items-center justify-center">
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 text-gray-700 text-bold">
                    ...
                    <input type="text" name="search" id="search"
                        class="form-control rounded-md border-0 py-7 pl-20 text-gray-900 sm:text-sm sm:leading-6 w-2/3"
                        placeholder="Find high-rated hostels">
                </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 container">
        <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">We serve you the most affordable top notched private
                hostels and apartments for your accommodation. Acknowledged the first, most secured and fastest private
                hostel
            ...
            <div class="row">
                <div class="pl-16 mb-3 col-md-4">
                    <div class="text-base font-semibold leading-7 text-gray-900">
                        <div
                            class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6 text-white text-bold">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>
                        </div>
                    ...
                    <span class="mt-2 text-base leading-7 text-gray-600">Search for the best hostels and apartments and
                        book the
                        room
                        that suits you.</span>
                </div>
...
<section id="category">
    <div class="container mx-auto mt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-6 w-full">
            ...
            <div class="relative p-4 w-full bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg flex flex-col justify-center items-center"
                style="min-height: 160px">
                <div class="w-16 h-16 bg-gray-200 rounded-lg">
                    <img src="{{$school->img_url}}" alt="{{$school->name}}" </div>

                    <h2 class="mt-2 text-gray-800 text-sm text-center font-semibold line-clamp-1">
                        {{$school->name}}
                    </h2>
                </div>
            </div>
  ...
  <div class="relative z-10">
    <div class="w-10/12">
      ...
      <h3 class="font-medium text-gray-500">
        Do you have house that you want to rent? Advertise it with us for free.
      </h3>
