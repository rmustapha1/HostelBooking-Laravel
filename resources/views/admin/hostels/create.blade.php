                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Hostel Type')}} *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Hostel Name')}} *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Hostel Code')}} *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-12 mt-2" id="diffPrice-option">
                                    <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1">&nbsp;
                                        {{trans('file.This product has different price for different warehouse')}}</h5>
                                </div>
